      ...
      <Box sx={{ mt: 3 }}>
        ...
        <Grid container spacing={2}>
          <Card variant="outlined" sx={{ height: "100%" }}>
            Advanced Model: {prediction ? prediction : "Please enter a input"}
          </Card>

          <Card variant="outlined" sx={{ height: "100%" }}>
            Bernoulli Naive Bayes:{" "}
            {bernoulli ? bernoulli : "Please enter a input"}
          </Card>
          <Card variant="outlined" sx={{ height: "100%" }}>
            Complement Naive Bayes:{" "}
            {complement ? complement : "Please enter a input"}
          </Card>
          <Card variant="outlined" sx={{ height: "100%" }}>
            Gaussian Naive Bayes: {gaussian ? gaussian : "Please enter a input"}
          </Card>
          <Card variant="outlined" sx={{ height: "100%" }}>
            Multinomial Naive Bayes:{" "}
            {multinomial ? multinomial : "Please enter a input"}
          </Card>
        </Grid>
      </Box>
    </Box>
